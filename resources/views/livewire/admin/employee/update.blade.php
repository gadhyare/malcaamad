<div class="container my-2 py-2">
    <div class="card  border-0 col-xs-12 col-sm-12 col-md-8">
        <div class="card-header title px-3 text-white"> تعديل البيانات الأساسية للموظف  [ {{$name}} ]</div>
        <div class="card-body">
            <form  class="fw-bold" enctype="multipart/form-data">
                ...
                <button type="submit" wire:click.prevent="update" class="btn btn-success col-12 m-auto">
