                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data" id="frm1">
                        ...
                        <div class="form-group"><label for="dep_id"> الصف الدراسي </label>
                            <select name="dep_id" id="dep_id" class="form-select  rounded-0 px-5 "
                        ...
                        <div class="form-group"><label for="dep_id"> المادة </label> <select name="dep_id"
                                id="dep_id" class="form-select rounded-0 px-5"
                        ...
                        <div class="form-group"><label for="cls_id"> الفترة </label> <select name="cls_id"
                                id="cls_id" class="form-select  rounded-0 px-5 " wire:model="shifts_id">
                        ...
                        <div class="form-group"><label for="grp_id"> المجموعة </label>
                            <select name="grp_id" id="grp_id" class="form-select  rounded-0 px-5 "
                        ...
                        <div class="form-group"><label for="sec_id"> القسم </label> <select name="sec_id"
                                id="sec_id" class="form-select  rounded-0 px-5 " wire:model="sections_id">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{$exam->students_info->name}} {{$exam->students_info->father->name}}</td>
                                <td class="text-center">{{$exam->students_info->father->number}} - {{$exam->students_info->id}}</td>
