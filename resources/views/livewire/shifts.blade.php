...
<div class="col-xs-12 col-sm-12 col-md-8">
        ...
        <x-table :headers="['#', 'الفترةs', 'الحالة', 'التعديل', 'الحذف']">
            ...
            @foreach ($shifts as $shift)
                <tr>
                    ...
                    <td>
                        <button class="btn bg-success-dark text-white  px-2 py-0 shadow-lg rounded-0" wire:click="updateRec({{ $shift->id }})"
